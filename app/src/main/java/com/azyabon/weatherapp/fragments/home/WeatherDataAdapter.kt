...
import com.azyabon.weatherapp.databinding.ItemContainerCurrentWeatherBinding
import com.azyabon.weatherapp.databinding.ItemContainerForecastBinding
    ...
    inner class CurrentWeatherViewHolder(
        ...
        fun bind(currentWeather: CurrentWeather) {
            with(binding) {
                ...
                tvChanceOfRainy.text = String.format("%s%%", currentWeather.chanceOfRain)
            }
        }
    }
